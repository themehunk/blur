...
<figure class="wp-block-image size-full"><img src="' . esc_url( BLUR_URL . 'assets/images/').'oneone.png" alt="" class="wp-image-734"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|40","padding":{"bottom":"var:preset|spacing|30"}}}} -->
<div class="wp-block-column" style="padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"},"border":{"width":"0px","style":"none"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group" style="border-style:none;border-width:0px"><!-- wp:group {"style":{"border":{"right":{"width":"0px","style":"none"}},"spacing":{"padding":{"right":"var:preset|spacing|50"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="border-right-style:none;border-right-width:0px;padding-right:var(--wp--preset--spacing--50)"><!-- wp:image {"id":724,"width":76,"height":58,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( BLUR_URL . 'assets/images/').'icontwo.png" alt="" class="wp-image-724" width="76" height="58"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<div class="wp-block-column" style="padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:group {"style":{"border":{"right":{"width":"0px","style":"none"}},"spacing":{"padding":{"right":"var:preset|spacing|50"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="border-right-style:none;border-right-width:0px;padding-right:var(--wp--preset--spacing--50)"><!-- wp:image {"id":726,"width":76,"height":76,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( BLUR_URL . 'assets/images/').'iconthree.png" alt="" class="wp-image-726" width="76" height="76"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<div class="wp-block-column" style="padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:group {"style":{"border":{"right":{"width":"0px","style":"none"}},"spacing":{"padding":{"right":"var:preset|spacing|50"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="border-right-style:none;border-right-width:0px;padding-right:var(--wp--preset--spacing--50)"><!-- wp:image {"id":728,"width":76,"height":70,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( BLUR_URL . 'assets/images/').'icon4.png" alt="" class="wp-image-728" width="76" height="70"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
