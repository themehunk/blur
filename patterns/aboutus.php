...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"large"} -->
<h2 class="has-large-font-size" style="font-style:normal;font-weight:400">Uniquely-Designed, Made In The UAE, And Comfortable</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"}},"textColor":"primary","fontSize":"medium"} -->
<p class="has-primary-color has-text-color has-medium-font-size" style="line-height:1.6">Mauris tempus leo orci, sagittis aliquam ligula euismod ut. Vivamus laoreet eu felis ut dignissim. Nam elementum sem sed eros dapibus auctor. Etiam vulputate convallis sem eu maximus. Donec et molestie dui, vitae consequat libero. Nullam semper, tellus sed placerat placerat,</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-accent-color has-text-color wp-element-button" style="padding-top:1rem;padding-right:1rem;padding-bottom:1rem;padding-left:1rem">Explore More</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
