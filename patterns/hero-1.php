...
$strings = array(
    ...
    'subtitle' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua.', 'blur' ),
    'button'   => __( 'Learn More', 'blur' ),
);

return array(
    'title'      =>__( 'Hero 1 Section', 'blur' ),
...
<figure class="wp-block-image aligncenter size-full"><img src="' . esc_url( BLUR_URL . 'assets/images/').'africa-riano.png" alt="" class="wp-image-1724"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
