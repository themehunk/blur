...
<h2 class="has-text-align-center has-background-color has-text-color has-extra-large-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">Get Flat 30% off on </h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-background-color has-text-color has-upper-heading-font-size">Bags, Shoes and womens wear</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button aligncenter"><a class="wp-block-button__link has-primary-color has-background-background-color has-text-color has-background wp-element-button">SHOP NOW</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->',
