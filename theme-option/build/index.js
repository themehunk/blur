    ...
    const renderData = data.map(item => {
      const renderDataa = Object.keys(item).map(items => {
        if (item[items].status == 'pro-installed') {
          nameTxt = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, item[items].name, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Pro', 'blur')));
          proDiv = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
            target: "_blank",
            className: "th-optn-link th-view-m",
            href: item[items].link
          }, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('View More', 'blur'));
          ;
          ...
          proDiv = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
            target: "_blank",
            className: "th-optn-link th-go-pro",
            href: item[items].link
          }, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Go Pro', 'blur'));
