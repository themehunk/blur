...
function PluginData() {
  ...
  if(wpapi.thpc_status.thpc_pro_active == 'pro-activate'){
    ...
    thpc_activeDetail= __( 'Documentation', 'blur' );
  ...
  if(wpapi.thaps_status.thaps_pro_active == 'pro-activate'){
    ...
    thaps_activeDetail= __( 'Documentation', 'blur' );
    ...
    thaps_activeDetail= __( 'Details & Version', 'blur' );
    ...
    thaps_activeProText= __( 'Go Pro', 'blur' );
  ...
  if(wpapi.thiowc_status.thiowc_pro_active == 'pro-activate'){
    ...
    thiowc_activeDetail= __( 'Documentation', 'blur' );
    ...
    thiowc_activeDetail= __( 'Details & Version', 'blur' );
    ...
    thiowc_activeProText= __( 'Go Pro', 'blur' );
  ...
  if(wpapi.thvs_status.thvs_pro_active == 'pro-activate'){
    ...
    thvs_activeDetail= __( 'Documentation', 'blur' );
    ...
    thvs_activeDetail= __( 'Details & Version', 'blur' );
    ...
    thvs_activeProText= __( 'Go Pro', 'blur' );
  ...
  if(wpapi.thlf_status.thlf_pro_active == 'pro-activate'){
    ...
    thlf_activeDetail= __( 'Documentation', 'blur' );
  ...
  if(wpapi.thwpbl_status.thwpbl_pro_active == 'pro-activate'){
    ...
    thwpbl_activeDetail= __( 'Documentation', 'blur' );
